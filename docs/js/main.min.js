...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../local_modules/jquery/dist/jquery.min */ \"./src/local_modules/jquery/dist/jquery.min.js\");\n/* harmony import */ var _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper */ \"./node_modules/swiper/swiper.esm.js\");\n\n\nswiper__WEBPACK_IMPORTED_MODULE_1__[\"Swiper\"].use([swiper__WEBPACK_IMPORTED_MODULE_1__[\"Mousewheel\"], swiper__WEBPACK_IMPORTED_MODULE_1__[\"Navigation\"]]);\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n  _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.video-player').parent().click(function () {\n    if (_local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.video-player').get(0).paused) {\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.video-player').get(0).play();\n    } else {\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.video-player').get(0).pause();\n      _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()(this).children('.video__overlay').fadeIn();\n    }\n\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.video__overlay').addClass('is-hidden');\n    _local_modules_jquery_dist_jquery_min__WEBPACK_IMPORTED_MODULE_0___default()('.video__play').addClass('is-hidden');\n  });\n  var expertsSlider = new swiper__WEBPACK_IMPORTED_MODULE_1__[\"Swiper\"](\".expert-slider\", {\n    loop: false,\n    speed: 800,\n    slidesPerView: 2,\n    slidesPerColumn: 1,\n    spaceBetween: 10,\n    navigation: {\n      nextEl: '.slideNext-btn',\n      prevEl: '.slidePrev-btn'\n    },\n    breakpoints: {\n      768: {\n        slidesPerView: 3,\n        slidesPerColumn: 2,\n        spaceBetween: 30\n      }\n    }\n  }); // const mobileMenu = document.querySelector(`.mobile-menu`),\n  //     menuBtn = document.querySelector(`.header__btn-menu`),\n  //     menuLink = document.querySelectorAll(`.mobile-menu__list-link`)\n  // menuBtn.addEventListener(`click`, function () {\n  //     if (mobileMenu.classList.contains(`is-active`)) {\n  //         mobileMenu.classList.remove(`is-active`)\n  //         menuBtn.classList.remove(`is-open`)\n  //     } else {\n  //         mobileMenu.classList.add(`is-active`)\n  //         menuBtn.classList.add(`is-open`)\n  //     }\n  // })\n  // menuLink.forEach((el) => {\n  //     el.addEventListener(`click`, () => {\n  //         mobileMenu.classList.remove(`is-active`)\n  //         menuBtn.classList.remove(`is-open`)\n  //     })\n  // })\n});\n\n//# sourceURL=webpack:///./src/js/main.js?");
